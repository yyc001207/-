                ...
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a
                    ...
                    <span
                      ...
                      class="iconfont"
                      :class="{
                        'icon-clouddownload-fill': isDesc,
                        'icon-cloudupload-fill': isAsc,
                      }"
                    ></span
                  ></a>
                </li>
...
export default {
  ...
  methods: {
    ...
    changeOrder(flag) {
      ...
      if (flag == originFlag) {
        originSort == 'desc' ? (originSort = 'asc') : (originSort = 'desc')
      } else {
        originFlag = flag
        originSort = 'desc'
      }
      originOrder = `${originFlag}:${originSort}`
